...
val projectAttributes = mapOf(
    "Main-Class" to "factorial.using.string.maths.AppKt" ,
...
dependencies {
    implementation(files(download("https://github.com/SanOtaku09/String-Maths/releases/download/add_and_sub/lib.jar")))
